     ...
     ?>
       ...
       <?php  
         ...
         ?>
            ...
            <form class="well span6" name="signup" action="updatestudent.php" method="post">
              <label> Name: </label>  
              <input class="span3" type="text" name="name" value="<?php echo $row['name'];?>">   <br>
             <label> Username : </label> 
              <input class="span3" type="text" name="username" value="<?php echo $row['username'];?>">  <br>
             Password : <input class="span3" type="password" name="password" value="<?php echo $row['password'];?>">  <br>
             CG : <input class="span3" type="text" name="cg" value="<?php echo $row['cg'];?>">  <br>
             stream :   
             <input class="span3" type="radio" name="stream" value="cs"> CS 
             <input class="span3" type="radio" name="stream" value="ee"> EE 
             <input class="span3" type="radio" name="stream" value="me"> ME  <br>
