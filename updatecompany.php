...
<br>
    ...
    <?php
     ...
     ?>
      ...
      mysqli_query($con,"update company set name='".$_POST['name']."',username='".$_POST['username']."',password='".$_POST['password']."',address='".$_POST['address']."',website='".$_POST['website']."',type='".$_POST['type']."',namehr='".$_POST['namehr']."',emailhr='".$_POST['emailhr']."',jobpost='".$_POST['jobpost']."' where pid=".$row['pid'].";");
