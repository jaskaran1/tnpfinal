...
<br>
    ...
    <?php
     ...
     ?>
            ...
            <form class="well span6" name="signup" action="registerstudent.php" method="post">
              <label> Name: </label>  
              <input class="span3" type="text" name="name">   <br>
             <label> Username : </label> 
              <input class="span3" type="text" name="username" value=" ">  <br>
             Password : <input class="span3" type="password" name="password" value="">  <br>
             CG : <input class="span3" type="text" name="cg">  <br>
             stream :   
       ...
       <?php  
         ...
         ?>
            ...
            <p> logout to register as a new student </p>
